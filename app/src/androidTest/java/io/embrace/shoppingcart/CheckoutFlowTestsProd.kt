...
class CheckoutFlowTestsProd {
        ...
        fun setupClass() {
            ...
            MockNetworkConfigOverrides.override =
                MockNetworkConfig(
                    ...
                    placeOrderScenario = NetworkScenario.FAILURE, // Fail fast if hybrid is not wired for orders
                )
        }
    }
    ...
    fun full_checkout_happy_path() {
        ...
        composeRule.waitUntil(conditionDescription = "order_failure", 30_000) {
